...
/>
      ...
      <section id="about" className="py-16 bg-white text-[#1F2937]">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-6 text-[#1E3A8A]">About THS Consulting</h2>

          <div className="max-w-3xl text-[#4B5563] leading-relaxed space-y-3">
      ...
      <section id="services" className="py-16 bg-[#F8FAFC] text-[#1F2937]">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-10 text-[#1E3A8A]">Our Services</h2>

          <div className="grid md:grid-cols-3 gap-8">

            <div className="p-7 bg-white rounded-2xl border border-[#E2E8F0] shadow-sm">
              <h3 className="text-xl font-semibold mb-3 text-[#1E3A8A]">IT Consulting & Strategy</h3>
            ...
            <div className="p-7 bg-white rounded-2xl border border-[#E2E8F0] shadow-sm">
              <h3 className="text-xl font-semibold mb-3 text-[#1E3A8A]">Talent Solutions</h3>
              <ul className="text-[#4B5563] space-y-1.5">
            ...
            <div className="p-7 bg-white rounded-2xl border border-[#E2E8F0] shadow-sm">
              <h3 className="text-xl font-semibold mb-3 text-[#1E3A8A]">Software Engineering</h3>
              <ul className="text-[#4B5563] space-y-1.5">
      ...
      <section id="whyus" className="py-16 bg-[#F8FAFC] text-[#1F2937]">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-8 text-[#1E3A8A]">Why THS Consulting</h2>
      ...
      <section id="careers" className="py-16 bg-white text-[#1F2937]">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-8 text-[#1E3A8A]">Careers at THS Consulting</h2>
      ...
      <section id="contact" className="py-14 bg-[#F8FAFC] text-[#1F2937]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="inline-block text-left bg-white p-7 rounded-2xl shadow-sm border border-[#E2E8F0]">
            ...
            <p className="text-[#4B5563] mb-3"><strong>Phone:</strong> 818‑588‑6061</p>
          </div>
        </div>
      </section>
